        ...
        public void ThreadHandle(object ClsParam)
        {
            ...
            foreach (DataRow dr in dtMaster.Rows)   //对主表数据逐条处理，每条生成一个报文
            {
                ...
                try
                {
                    ...
                    //RSA秘钥  java生成c#解密xml     
                    string privatekey = "<RSAKeyValue><Modulus></Modulus><Exponent>AQAB</Exponent><P>2NVYKsj/wzwrx/6ysEeYmZKHQfpBOaMdB+VCdqbft8AcxEfkIsAkWVudovEfUTA6i6etVz/7tHvviIbcqOt0tE4AJfR7Mh4c5/Wze8Mvu7mtWaQslou1Qik5QQgtkiEhC3384ySAe7YFttQ44R/ub8TrUNQd9W/uQ2uFz28J8ms=</P><Q>xhBcj46qTcljtcXdoF9v5hf5X5xzVlraMQ2tHk1S4xbeNY5crCxKe4SEz5HszKr5MI7Nny8ymHQeo5uGoKNwpAqIodXBIyt1HP5KIeLoqz8RBP4YfmPblAanzxv5flTi9Dpduadghsf8iMWgHLouIwlLOr73ZWLqShytGVNdiKc=</Q><DP>XoaTCwPYy6m9hFA6YbK0ia5hHJgWOyQqkbiWAte4i4hKgh69C5Erx3CzBceL2X7m5t7QKEsSVZn50FDKfTE4DSo70lAELNMH0u8/sWJjuri1I3D4pyB8gj0qYnlINH4Qw8vGpNbS1BuD3jIiIbIj5cG4u+HctZR4EBgdm1JSycU=</DP><DQ>uEYUuAO18zVBrabv8fuZMmxvuULoFBnnEuh0ftLWIS3vg8h19EIo8g5zOmO7+xe/TCwwpr/UxP6UWweiE+a8MAMU5+zmCoCuL1FvS2O/sUO14/08cKsbafdfPVP7pkv3894xwT82kW+TRvUHaHLX5gUJlxiBODT1YgqYCg4D4dU=</DQ><InverseQ>YxXLqXrqdioTVueLsCcw4I5GloSyuiYcnS5i39xwo7zr3oXdt5hSn8MdyTdRLw6dypZ9kO9jbQs2x4PITySVs+VUkwbp9lhyJ60Ct2JhQzc4B5DY9mBfn/5eAngMY6RTmvfB7t2XQCpVJW18U9pGYGe89LpJ1tJiFk7mH7K1gOQ=</InverseQ><D></D></RSAKeyValue>";
                    ...
                    //                //指定编码格式转换扯base64
                    //rtsignedData = RSAHelper.EncodeBase64(Encoding.UTF8, rtsignedData);
                    //             //获取Hash描述
                    //             RSAHelper.GetHash(rtsignedData, ref HashData2);

                    //             RSAHelper.SignatureDeformatter(privatekey, rtencryptedKey)
