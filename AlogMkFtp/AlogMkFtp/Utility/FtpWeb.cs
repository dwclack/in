...
namespace AlogMkFtp.Utility
{
    ...
    public class FtpWeb
    {
        ...
        public FtpWeb(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
            ...
            //ftpServerIP = "10.10.10.23";
            //ftpRemotePath = FtpRemotePath;
            //ftpUserID = "ftptest1";
            //ftpPassword = "ftptest1";
        ...
        //    //}
        //    //Console.ReadLine();
        //    FtpWeb fw = new FtpWeb("10.10.10.23", "", "aa1", "aa");
        ...
        public string[] GetFilesDetailList()
        {
            ...
            try
            {
                ...
                if (result != null && result.ToString().LastIndexOf("\n") > 0)
                {
        ...
        public string[] GetDirectoryList()
        {
            ...
            if (drectory != null)
            {
                ...
                {
                    if (str != null && str != "" && str.Trim() != "" && str.Trim().Length >= 50)
                    {
                        if (str.Trim().Substring(0, 1).ToUpper() == "D")
                        {
                            m += str.Substring(49).Trim() + "\n";
                        }
                    }
                }
            }
        ...
        public void ReName(string currentFilename, string newFilename)
        {
            ...
            try
            {
                ...
                reqFTP.RenameTo = Path.GetFileNameWithoutExtension(newFilename);
                reqFTP.UseBinary = true;
                reqFTP.Credentials = new NetworkCredential(ftpUserID, ftpPassword);
                FtpWebResponse response = (FtpWebResponse)reqFTP.GetResponse();
                Stream ftpStream = response.GetResponseStream();
